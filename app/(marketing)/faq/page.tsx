...
export const metadata: Metadata = {
  title: 'FAQ',
  description: 'Najczęściej zadawane pytania o park trampolin Saltos.',
};
...
export default function Page() {
  return (
    <section className="container py-24">
      ...
      <p className="mt-4 max-w-2xl text-white/70">Najczęściej zadawane pytania o park trampolin Saltos.</p>
    </section>
  );
}
